...
public class DataInitializationService {
    ...
    public void init() {
        ...
        Permission ratingPermission = permissionRepo.findByName("RATING")
                .orElseGet(() -> permissionRepo.save(new Permission("RATING")));
        ...
        //doctor
        Permission createArticlePermission = permissionRepo.findByName("CREATE_ARTICLE")
                .orElseGet(() -> permissionRepo.save(new Permission("CREATE_ARTICLE")));

        Permission removeArticlePermission = permissionRepo.findByName("REMOVE_ARTICLE")
                .orElseGet(() -> permissionRepo.save(new Permission("REMOVE_ARTICLE")));

        Role userRole = roleRepo.findByName("USER")
                .orElseGet(() -> roleRepo.save(new Role("USER",
                        Arrays.asList(favoritePermission,updateLocPermission,getUserLocationPermission,locationPermission,getAllPermission,getPermission,buyPermission,showCardPermission,oredPermission,ratingPermission))));
        ...
        Role doctorRole = roleRepo.findByName("DOCTOR")
                .orElseGet(() -> roleRepo.save(new Role("DOCTOR", Arrays.asList(createArticlePermission,removeArticlePermission))));
    }
}
